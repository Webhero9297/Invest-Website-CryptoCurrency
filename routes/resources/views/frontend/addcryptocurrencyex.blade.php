                    ...
                    <form method="POST" action="{{ route('store.crypto.currency') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="input-group spinner" style="width: calc(100% - 18px);">
                                    <input type="text" class="form-control input-form-control grey-border" id="quantity" name="quantity" value="{{ $quantity }}" min="0" tabindex="2" style="font-size:24px;" value="1">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                <div class="input-group spinner" style="width: calc(100% - 18px);">
                                    <input type="text" class="form-control input-form-control grey-border" id="purchased_price" name="purchased_price" value="{{ $purchased_price }}" tabindex="3" style="font-size:24px;" value="1" min="0">
                                    <div class="input-group-btn-vertical">
