...
<head>
    ...
    <title>Moonfolio Terms and Conditions</title>
    <link href="https://www.websitepolicies.com/public/css/privacy.min.css?v=1497015620" rel="stylesheet" type="text/css">
...
<body class="guest">
    <header id="header">
        <div class="container">
            <div class="row">
                <div class="col-ms-12">
                    <h1><span>Moonfolio Terms and Conditions</span></h1>
                </div>
            </div>
        </div>
    </header>
            ...
            <div class="row">
                <section class="col-ms-12">
                    <article>
                        ...
                        <p>This document was last updated on January 30, 2018</p>
                    </article>
                </section>
            </div>
        </div>
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-ms-12">
                    <a target="_blank" rel="nofollow" href="javascript:history.back()">Moonfolio</a> </div>
            </div>
        </div>
    </footer>
